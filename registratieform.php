 <?php
   ...
   echo "Wachtwoord: <br>";
   echo "<input type = \"password\" id = \"passwordini\" name = \"passwordini\" onfocus=\"Verwijderfoutboodschap()\"><br><br>";
   echo "Herhaal wachtwoord: <br>";
   echo "<input type = \"password\" id = \"passwordrepeat\" name = \"passwordrepeat\" onchange=\"PWcontrole()\" onfocus=\"Verwijderfoutboodschap()\"><br><br>";
